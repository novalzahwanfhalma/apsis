            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Survei Disetujui</h3>
                        <p class="text-subtitle text-muted">Daftar Survei Disetujui</p>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home_admin') }}">Survei</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Disetujui</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <table class="table table-striped" id="table1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('detail_disetujui', ['id_survei' => $item->id_survei]) }}">
