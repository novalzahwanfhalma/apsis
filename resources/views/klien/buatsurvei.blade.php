                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input type="text" id="helperText" class="form-control" placeholder="dd-mm-yyyy">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="basicInput">Opsi 1</label>
                                    <input type="text" class="form-control" id="basicInput"
                                        placeholder="Opsi 1">
                                </div>
                                <div class="form-group">
                                    <label for="basicInput">Opsi 2</label>
                                    <input type="text" class="form-control" id="basicInput"
                                        placeholder="Opsi 2">
                                </div>
                                <div class="form-group">
                                    <label for="basicInput">Opsi 3</label>
                                    <input type="text" class="form-control" id="basicInput"
                                        placeholder="Opsi 3">
                                </div>
                                <div class="form-group">
                                    <label for="basicInput">Opsi 4</label>
                                    <input type="text" class="form-control" id="basicInput"
                                        placeholder="Opsi 4">
                                </div>
                                <div class="form-group">
                                    <label for="basicInput">Opsi 5</label>
                                    <input type="text" class="form-control" id="basicInput"
                                        placeholder="Opsi 5">
                                </div>
                            </div>
