                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" class="form-control"
                                                    placeholder="Name" id="first-name-icon" name="fullName" value="{{ $data[0]->nama }}">
                                        ...
                                        <div class="form-group has-icon-lefts">
                                            <div class="position-relative">
                                                ...
                                                <div class="form-control-icon avatar avatar.avatar-im">
                                                    <img src="{{ URL::to('/') }}/images/photo_defaults.jpg">
                                                </div>
                                        ...
                                        <div class="form-group position-relative has-icon-left mb-4">
                                            <fieldset class="form-group">
                                                <select class="form-select" name="role_name" id="role_name">
                                                    <option value="{{ $data[0]->role_name }}" {{ ( $data[0]->role_name == $data[0]->nama) ? 'selected' : ''}}> 
                                                        {{ $data[0]->role_name }}
                                                    </option>
